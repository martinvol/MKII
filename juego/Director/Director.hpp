...
enum movimiento {Nada, Derecha, Izquierda, Arriba, Abajo, ArribaDerecha, ArribaIzquierda, AbajoDerecha, AbajoIzquierda, PiniaAlta, PiniaBaja, MirarDerecha, MirarIzquierda, Pararse, CubrirAlto, CubrirBajo, ArrojarArma, PatadaAlta, PatadaBaja, PatadaBajaAgachado, PatadaAltaAgachado};
