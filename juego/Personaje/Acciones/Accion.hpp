...
typedef enum accion_posible {QUIETO, CAMINAR_DERECHA, CAMINAR_IZQUIERDA, 
							SALTAR, SALTARDIAGONAL_IZQ, SALTARDIAGONAL_DER, 
							AGACHARSE, PARARSE, PINIAALTA, PINIABAJA, MIRARDERECHA, 
							MIRARIZQUIERDA, PATADAALTA, PATADABAJA, PATADABAJAAGACHADO, 
							PATADAALTAAGACHADO, ARROJARARMA, CUBRIRALTO, CUBRIRBAJO, TRABA} accion_posible;
