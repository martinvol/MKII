...
typedef enum accion_posible {QUIETO, CAMINAR_DERECHA, CAMINAR_IZQUIERDA, SALTAR, SALTARDIAGONAL_IZQ, SALTARDIAGONAL_DER, AGACHARSE, PINIAALTA, PINIABAJA, MIRARDERECHA, MIRARIZQUIERDA, PATADAALTA, PATADABAJA, ARROJARARMA, CUBRIRSE} accion_posible;
