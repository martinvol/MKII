...
bool Agacharse::permiteAccion(accion_posible nuevaAccion){
	if ((nuevaAccion == PARARSE) || (nuevaAccion == CUBRIRBAJO) || (nuevaAccion == PATADABAJAAGACHADO) || (nuevaAccion == PATADAALTAAGACHADO) || (nuevaAccion == GANCHO) || (nuevaAccion == RECIBIRGOLPEAGACHADO) || (nuevaAccion == CAERPORTRABA)) return true;
	return false;
}
