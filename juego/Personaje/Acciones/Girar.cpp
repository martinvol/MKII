...
Girar::Girar(string ruta, SDL_Renderer* ren, float despl_x, float despl_y, float h_max, int hue_init, int hue_fin, int hue_offset):Accion(8,ruta,ren, despl_x, despl_y, h_max, hue_init, hue_fin, hue_offset){
