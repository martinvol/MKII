...
Desaparecer::Desaparecer(string ruta, SDL_Renderer* ren, float despl_x, float despl_y, float h_max, int hue_init, int hue_fin, int hue_offset):Accion(43,ruta,ren, despl_x, despl_y, h_max, hue_init, hue_fin, hue_offset){
...
CoordenadaLogica* Desaparecer::execute(CoordenadaLogica* coord_personaje){
	Accion::cambiarModo();
